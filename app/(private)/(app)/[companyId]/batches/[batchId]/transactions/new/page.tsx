...
export default function NewBatchTransactionPage() {
  ...
  const handleCancel = useCallback(() => {
    router.push(`/${companyId}/batches/${batchId}`);
      ...
      <div className="transaction-form__page-header">
        <div>
          <button
            ...
            onClick={() => router.push(`/${companyId}/batches/${batchId}`)}
          >
          ...
          <p className="transaction-form__page-subtitle">
            Registra una nueva operación financiera asociada a este lote.
          </p>
        </div>
      </div>
